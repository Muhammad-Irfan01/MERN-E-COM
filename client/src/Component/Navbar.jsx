...
const Navbar = ({containerStyle}) => {
  return (
    <nav className={`${containerStyle}`}>
      <NavLink to={'/'} className={({isActive}) => isActive ? 'text-orange-400 relative flex-1 after:w-full after:h-[1] after:bg-orange-400 after:absolute after:-bottom-3 after:right-0' : ''}><div className="flex gap-x-1 items-center"><MdHomeFilled/>Home</div></NavLink>
